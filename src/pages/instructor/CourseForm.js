      ...
      courseService
        ...
        .then((res) => {
          ...
          setForm({
            ...res,
            courseContent,
            instructorId: res.instructorId || instructorId,
          });
        })
        .catch((err) => {
          console.error("Error loading course:", err);
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      ...
                      try {
                        ...
                        setError(
                          "The provided course material link is not a valid URL."
                        );
                        setSuccessMessage("");
                      }
                    }}
